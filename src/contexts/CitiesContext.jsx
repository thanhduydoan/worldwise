...
function CitiesProvider({ children }) {
    ...
    async function createCity(newCity) {
        ...
        try {
            ...
            dispatch({ type: 'rejected', payload: 'There was an error to create city' })
    ...
    async function deleteCity(id) {
        ...
        try {
            ...
            dispatch({ type: 'rejected', payload: 'There was an error to dele city.' })

        } finally {
        }

    }
    return (<CitiesContext.Provider value={{ cities, isLoading, currentCity, error, getCity, createCity, deleteCity }}>
        {children}
